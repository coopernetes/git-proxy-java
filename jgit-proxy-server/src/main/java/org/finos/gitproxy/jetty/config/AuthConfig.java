 ...
 *
 * <ul>
 *   <li>{@code static} (default) — usernames and BCrypt password hashes configured directly in {@code users:}
...
public class AuthConfig {
    ...
    /** Active authentication provider. Accepted values: {@code static}, {@code ldap}, {@code oidc}. */
